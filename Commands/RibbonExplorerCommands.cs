...
public class RibbonTabsCommand : ICommand
{
    ...
    public async Task<int> ExecuteAsync(AutomationElement revitWindow, string[] args, CancellationToken ct = default)
    {
        ...
        if (ribbonList == null)
        {
            Console.Write(OutputFormatter.FormatError("NotFound", "ribbon list", null, Program.GlobalOptions));
            return 1;
        }
        ...
        Console.Write(OutputFormatter.FormatError("NotFound", searchName, ribbonTabs.Select(t => t.name).ToList(), Program.GlobalOptions));
        return 1;
    }
...
public class RibbonButtonsCommand : ICommand
{
    ...
    public async Task<int> ExecuteAsync(AutomationElement revitWindow, string[] args, CancellationToken ct = default)
    {
        ...
        {
            Console.Write(OutputFormatter.FormatError("NotFound", "UI tree", null, Program.GlobalOptions));
            return 1;
        }
        ...
        {
            Console.Write(OutputFormatter.FormatError("NotFound", "ribbon tabs", null, Program.GlobalOptions));
            return 1;
        }
